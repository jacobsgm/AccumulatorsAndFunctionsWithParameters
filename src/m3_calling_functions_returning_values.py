...
def run_test_sum_of_digits():
    ...
    print('Test x expected:', expected)
    print('       actual:  ', answer)
    expected = 12
    answer = sum_of_digits(804)
    print('Test y expected:', expected)
    print('       actual:  ', answer)
    expected = 7
    answer = sum_of_digits(205)
    print('Test z expected:', expected)
    print('       actual:  ', answer)
